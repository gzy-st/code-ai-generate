...
import com.guozy.codeaigenerate.annotation.AuthCheck;
import com.guozy.codeaigenerate.common.BaseResponse;
import com.guozy.codeaigenerate.common.DeleteRequest;
import com.guozy.codeaigenerate.common.ResultUtils;
...
import com.guozy.codeaigenerate.model.dto.app.AppAdminUpdateRequest;
import com.guozy.codeaigenerate.model.dto.app.AppQueryRequest;
import com.guozy.codeaigenerate.model.dto.app.AppUpdateRequest;
...
public class AppController {
    ...
    /**
     * 分页查询精选的应用列表（priority > 0，按优先级和时间降序，支持根据名称查询，每页最多 20 个）
     *
     * @param appQueryRequest 查询请求
     * @return 脱敏后的分页精选应用列表
     */
